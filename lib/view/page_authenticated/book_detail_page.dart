...
import 'package:e_book_app/controller/cubit/book_text_detail/book_text_detail_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => BookTextDetailCubit(link: widget.book.text),
        ),
      ],
      child: BlocBuilder<BookTextDetailCubit, BookTextDetailState>(
                        ...
                        Stack(
                          children: [
                            ...
                            Positioned(
                              ...
                              right: 0,
                              child: Image.asset(
                                  'assets/icon_e_book_app_for_splash.png'),
                            ),
                            Positioned(
                              top: 305,
                              left:
